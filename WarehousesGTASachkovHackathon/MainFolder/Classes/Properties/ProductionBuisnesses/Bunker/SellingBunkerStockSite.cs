...
{
    static class SellingBunkerStockSiteSellingBunkerStockSite
    {
        ...
        public static int CalculateMoneyFromSale(double NofProduct, SellDistance sellDistance, MCProductionUpgrades upgrades)
        {
